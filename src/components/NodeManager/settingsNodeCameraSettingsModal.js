   ...
   <Card className="text-center">
    ...
    <Form>
      ...
      <Row>
        ...
        <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera1NetworkSettings.DefaultGateway} />
        </Col>
        <Col>
        <Form.Label>Dhcp</Form.Label>
        <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera1NetworkSettings.DhcpEnable} />
        </Col>
        ...
        <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera1NetworkSettings.SubnetMask} />
        </Col>
        <Col>
        <Form.Label>Dns 1</Form.Label>
        <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera1NetworkSettings.DnsServer1} />
        </Col>
        <Col>
        <Form.Label>Dns 2</Form.Label>
        <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera1NetworkSettings.DnsServer2} />
        </Col>
      ...
      <Row>
        ...
        <Form.Control readOnly size="sm" type="text" placeholder={state.currentNodeCamera1NetworkSettings.PhysicalAddress} />
      </Col>
       ...
       <Card className="text-center">
        ...
        <Form>
          ...
          <Row>
            ...
            <Col>
            <Form.Label>Gateway</Form.Label>
            <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera2NetworkSettings.DefaultGateway} />
            </Col>
            <Col>
            <Form.Label>Dhcp</Form.Label>
            <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera2NetworkSettings.DhcpEnable} />
            </Col>
            ...
            <Col>
            <Form.Label>Subnet</Form.Label>
            <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera2NetworkSettings.SubnetMask} />
            </Col>
            <Col>
            <Form.Label>Dns 1</Form.Label>
            <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera2NetworkSettings.DnsServer1} />
            </Col>
            <Col>
            <Form.Label>Dns 2</Form.Label>
            <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera2NetworkSettings.DnsServer2} />
            </Col>
          ...
          <Row>
            ...
            <Col>
            <Form.Label>MAC</Form.Label>
            <Form.Control readOnly size="sm" type="text" placeholder={state.currentNodeCamera2NetworkSettings.PhysicalAddress} />
          </Col>
       ...
       <Card className="text-center">
        ...
        <Form>
          ...
          <Row>
            ...
            <Col>
            <Form.Label>Gateway</Form.Label>
            <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera3NetworkSettings.DefaultGateway} />
            </Col>
            <Col>
            <Form.Label>Dhcp</Form.Label>
            <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera3NetworkSettings.DhcpEnable} />
            </Col>
            ...
            <Col>
            <Form.Label>Subnet</Form.Label>
            <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera3NetworkSettings.SubnetMask} />
            </Col>
            <Col>
            <Form.Label>Dns 1</Form.Label>
            <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera3NetworkSettings.DnsServer1} />
            </Col>
            <Col>
            <Form.Label>Dns 2</Form.Label>
            <Form.Control size="sm" type="text" placeholder={state.currentNodeCamera3NetworkSettings.DnsServer2} />
            </Col>
          ...
          <Row>
            ...
            <Col>
            <Form.Label>MAC</Form.Label>
            <Form.Control readOnly size="sm" type="text" placeholder={state.currentNodeCamera3NetworkSettings.PhysicalAddress} />
          </Col>
