...
export default function NodeManagerNewNodeModal() {
  ...
  return (
    <Modal
      dialogClassName="customModalNewNode"
                      ...
                      <Card.Body>
                        ...
                        <Row>
                          <Form.Group as={Col} controlId="formGridNodeLat">
                            ...
                            <Form.Control
                              type="number"
                              onChange={(e) => handleSubmit({ locationLat: e.target.value })}
                            />
                          </Form.Group>
                          <Form.Group as={Col} controlId="formGridNodeLng">
                            ...
                            <Form.Control
                              type="number"
                              onChange={(e) => handleSubmit({ locationLong: e.target.value })}
                            />
                          </Form.Group>
                        </Row>
                      </Card.Body>
                      ...
                      <Card.Body>
                        <Row>
                          <Form.Group as={Col} controlId="formGridBuddyDriveDevicePath">
                            ...
                            <Form.Control
                              type="text"
                              onChange={(e) => handleSubmit({ buddyDriveDevicePath: e.target.value })}
                            />
                          </Form.Group>
                        </Row>
                        <Row>
                          <Form.Group as={Col} controlId="formGridBuddyDriveMountPath">
                            ...
                            <Form.Control
                              type="text"
                              onChange={(e) => handleSubmit({ buddyDriveMountPath: e.target.value })}
                            />
                          </Form.Group>
                          ...
                          <Form.Group as={Col} controlId="formGridBuddyDriveEncrytption">
                            ...
                            <Form.Control
                              type="text"
                              onChange={(e) => handleSubmit({ buddyDriveEncryptionKey: e.target.value })}
                            />
                          </Form.Group>
                        </Row>
                        <Row>
                          <Form.Group as={Col} controlId="formGridBuddyDrive1HostName">
                            ...
                            <Form.Control
                              type="text"
                              onChange={(e) => handleSubmit({ BuddyDrive1HostName: e.target.value })}
                              size="sm"
                            />
                          </Form.Group>
                          ...
                          <Form.Group as={Col} controlId="formGridBuddyDrive1MountPath">
                            ...
                            <Form.Control
                              type="text"
                              onChange={(e) => handleSubmit({ BuddyDrive1MountPath: e.target.value })}
                              size="sm"
                            />
                          </Form.Group>
                        </Row>
                        <Row>
                          <Form.Group as={Col} controlId="formGridBuddyDrive2HostName">
                            ...
                            <Form.Control
                              type="text"
                              onChange={(e) => handleSubmit({ BuddyDrive2HostName: e.target.value })}
                              size="sm"
                            />
                          </Form.Group>
                          ...
                          <Form.Group as={Col} controlId="formGridBuddyDrive2MountPath">
                            ...
                            <Form.Control
                              type="text"
                              onChange={(e) => handleSubmit({ BuddyDrive2MountPath: e.target.value })}
                              size="sm"
                            />
                          </Form.Group>
                        </Row>
                      ...
                      <Card.Body>
                        <Row>
                          <Form.Group as={Col} controlId="formGridVideoDriveDevicePath">
                            ...
                            <Form.Control
                              type="text"
                              onChange={(e) => handleSubmit({ videoDriveDevicePath: e.target.value })}
                            />
                          </Form.Group>
                        </Row>
                        <Row>
                          <Form.Group as={Col} controlId="formGridVideoDriveMountPath">
                            ...
                            <Form.Control
                              type="text"
                              onChange={(e) => handleSubmit({ videoDriveMountPath: e.target.value })}
                            />
                          </Form.Group>
                          ...
                          <Form.Group as={Col} controlId="formGridVideoDriveEncrytption">
                            ...
                            <Form.Control
                              type="text"
                              onChange={(e) => handleSubmit({ videoDriveEncryptionKey: e.target.value })}
                            />
                          </Form.Group>
                        </Row>
                      </Card.Body>
                ...
                <Card className="text-left">
                  ...
                  <Card.Body>
                    <Form.Group as={Col} controlId="formGridServerURL">
                      ...
                      <Form.Control
                        type="text"
                        onChange={(e) => handleSubmit({ camera1IP: e.target.value })}
                        size="sm"
                      />
                    </Form.Group>
                    <Form.Group as={Col} controlId="formGridServerURL">
                      ...
                      <Form.Control
                        type="text"
                        onChange={(e) => handleSubmit({ camera1Type: e.target.value })}
                        size="sm"
                      />
                    </Form.Group>
                    <Form.Group as={Col} controlId="formGridServerURL">
                      ...
                      <Form.Control
                        type="number"
                        onChange={(e) => handleSubmit({ camera1Direction: e.target.value })}
                        size="sm"
                      />
                    </Form.Group>
                    <Form.Group as={Col} controlId="formGridServerURL">
                      ...
                      <Form.Control
                        type="text"
                        onChange={(e) => handleSubmit({ camera1Username: e.target.value })}
                        size="sm"
                      />
                    </Form.Group>
                    <Form.Group as={Col} controlId="formGridServerURL">
                      ...
                      <Form.Control
                        type="text"
                        onChange={(e) => handleSubmit({ camera1Password: e.target.value })}
                        size="sm"
                      />
                    </Form.Group>
                    <Form.Group as={Col} controlId="formGridServerURL">
                      ...
                      <Form.Control
                        type="text"
                        onChange={(e) => handleSubmit({ camera1FolderName: e.target.value })}
                        size="sm"
                      />
                    </Form.Group>
                  </Card.Body>
