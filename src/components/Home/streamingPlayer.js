...
export default function StreamingPlayer() {
  ...
  let camera1VideoUrl =
    'http://rtcc-server.shreveport-it.org:3000/api/cameraConfig/snapshot/' + state.currentNodeInfo.name + '/camera1';
  // eslint-disable-next-line
  let camera2VideoUrl =
    'http://rtcc-server.shreveport-it.org:3000/api/cameraConfig/snapshot/' + state.currentNodeInfo.name + '/camera2';

  // eslint-disable-next-line
  let camera3VideoUrl =
    'http://rtcc-server.shreveport-it.org:3000/api/cameraConfig/snapshot/' + state.currentNodeInfo.name + '/camera3';
